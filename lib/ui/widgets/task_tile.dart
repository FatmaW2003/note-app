...
final Task task;
  ...
  Widget build(BuildContext context) {
    return Container(
      padding:
      EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(SizeConfig.orientation==Orientation.landscape?4 :20),),
      ...
      child: Container(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          RotatedBox(quarterTurns: 3,
            child: Text(task.isCompleted==0?'To Do':'Completed',style: GoogleFonts.lato(
